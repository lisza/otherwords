...
document.addEventListener('DOMContentLoaded', function () {
  ...
  form.onsubmit = async function () {
    ...
    var resultList = document.getElementById('grid'); // change id to wherever my results live
    while (resultList.firstChild) {
      resultList.removeChild(resultList.firstChild);
    }
    results = inputWord ? await (0, _translate.translate)(inputWord) : null;
...
var _languages_util = __webpack_require__(3);

var _jsLevenshtein = __webpack_require__(7);

var _jsLevenshtein2 = _interopRequireDefault(_jsLevenshtein);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

console.log((0, _jsLevenshtein2.default)('brood', 'brot'));
...
var translate = exports.translate = function translate(inputWord) {
  ...
  gapi.client.init({
    ...
    Object.keys(_languages_util.langs).forEach(function (lang) {
      ...
      for (var i = 0; i < keys.length; i++) {
        if (response.result[keys[i]].status === 200) {
          ...
          results[keys[i]] = {
            ...
            'language': _languages_util.langs[keys[i]] };
        }
      }
