...
var populateGrid = function populateGrid(results) {
  Object.keys(results).forEach(function (key) {
    ...
    if (parentElement) {
      ...
      _tooltip.className = "tooltiptext";
      _tooltip.innerHTML = word.language;
      wordDiv.appendChild(_tooltip);

      // Show language tooltips onclick for touch screens
      addOnclickEvent(wordDiv);
...
var addOnclickEvent = function addOnclickEvent(wordDiv) {
