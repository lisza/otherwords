...
document.addEventListener('DOMContentLoaded', function () {
  ...
  form.onsubmit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var resultList;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            resultList = document.getElementById('grid');
            ...
            _context.next = 7;
            return (0, _translate.translate)(inputWord);
